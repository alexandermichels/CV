...
\resheading{Experience}
        ...
        \begin{titemize}
            ...
            \titem Worked with Ansible, CVMFS, Docker, Docker Swarm, Kubernetes, OpenStack, and Terraform.
        \end{titemize}
        ...
        \begin{titemize}
            \titem{Built and deployed toolkit to gain business insights from unstructured web data.}
        \end{titemize}
