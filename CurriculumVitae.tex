...
\subheading{External Funding}
\begin{mytable}

    2026    &   \textbf{Principal Investigator}; National Science Foundation (NSF); \$164,936 \newline
                Collaborative Research: CyberTraining: Implementation: Small: CITY-AI: CyberTraining for AI-Enabled Intelligent Urban Informatics and Smart City Innovation (\href{https://www.nsf.gov/awardsearch/show-award?AWD_ID=2612146}{2612146}) \\


\end{mytable}

\subheading{Internal Funding}
\begin{mytable}

    2026 & ROAD to DC \- Take Flight 2026, UTD \\

    2025 & Summer 2026 Undergraduate Research Apprenticeship Program, UTD (\$4,500) \\

\end{mytable}


\subheading{Supercomputing Resource Awards by NSF}
\begin{mytable}

    2023 & \textbf{Principal Investigator}; (Co-PI: Shaowen Wang), 400,000 credits. Advanced Cyberinfrastructure Coordination Ecosystem: Services \& Support (ACCESS) \newline ACCESS Explore Allocation for “SPACTS: a spatial partitioning algorithm for computing travel-time zones at scale” (CIS230031) \\
...
\resheading{Awards}
    ...
    \begin{mytable}
        2026 & William L. Garrison Award for Best Dissertation in Computational Geography, American Association of Geographers \\

        2026 & Finalist, J. Warren Nystrom Award, American Association of Geographers \\

        2025 & UCGIS I-GUIDE Community Champion, University Consortium for Geographic Information Science / I-GUIDE \\
        ...
        2020 & Computational Research Techniques Fellowship, Texas Advanced Computing Center\\
...
\vspace*{0.25cm}
    ...
    \begin{mytable}
        ...
        2025 & ``Introduction to the I-GUIDE Platform''. \textit{University of Texas at Dallas GIS Day 2025}. Richardson, TX. Nov, 19, 2025. \\

        2025 & ``Analyzing Evacuation Bottlenecks in the U.S. Road Network''. \textit{CyberTraining for Disaster Management (DTDM) Network}. Virtual. Nov 17, 2025. \\
    ...
    \subheading{Guest Lectures}

    \begin{mytable}

        2025 & ``CyberGIS for Scalable Spatial Accessibility Analysis''. \textit{GIS Applications in Public Health}, UT Southwestern. Dec 10, 2025. \\
    \end{mytable}
    ...
    \begin{mytable}
        ...
        2025 & ``Integrating CyberGIS and Big Data for Scalable Spatial Accessibility Analysis''. \textit{American Association of Geographers (AAG) Annual Meeting}. San Francisco, CA. Mar 18, 2026\\
    ...
    \subheading{Panelist}
    \begin{mytable}
        2026 & Convergent GeoAI and Cyberinfrastructure for Ethical, Sustainable, and Human-Environment Resilience. \textit{American Association of Geographers (AAG) Annual Meeting}. San Francisco, CA. Mar 18, 2026.\\

        2026 & AAG 2026 Symposium on Spatial AI and Data Science: Frontiers and Applications: Convergence Curriculum for Spatial AI and Data Science. \textit{American Association of Geographers (AAG) Annual Meeting}. San Francisco, CA. Mar 19, 2026.\\
 
        2026 & AAG 2026 Symposium on Spatial AI and Data Science: Frontiers and Applications: Challenges and Opportunities of Mobility and Spatial Accessibility. \textit{American Association of Geographers (AAG) Annual Meeting}. San Francisco, CA. Mar 19, 2026.\\
    \end{mytable}
...
\vspace*{0.25cm}
    ...
    \begin{mytable}
        Spring 2026 & \textbf{GIS Applications in Criminology (GGIS 6331/CRIM 6332)} \newline Geographic Information Science, UTDallas \\
        
        Fall 2025 & \textbf{Spatial Data Science (GGIS 4381/6321)} \newline Geographic Information Science, UTDallas \\
...
\vspace*{0.25cm}
    ...
    \subheading{Service to Professional Organizations}
    \begin{mytable}
        2026-27 & \textbf{Vice Chairperson}, AAG CyberInfrastructure Specialty Group (CISG) \\
    ...
    \begin{mytable}
        ...
        2026 & \textbf{Program Committee Member \& Reviewer}, \href{https://i-guide.io/forum/forum-2026/}{I-GUIDE Forum 2026 \& Harnessing the Data Revolution (HDR) Ecosystem Conference}\\

        2026 & \textbf{Symposium Chair}, \href{https://i-guide.io/aag-2026-symposium-on-spatial-ai-data-science-frontiers-and-applications/}{AAG 2026 Symposium on Spatial AI and Data Science: Frontiers and Applications}\\

        2026 & \textbf{Session Chair}, ``Innovations in Spatial Accessibility (1)'' \href{https://i-guide.io/aag-2026-symposium-on-spatial-ai-data-science-frontiers-and-applications/}{AAG 2026 Symposium on Spatial AI and Data Science: Frontiers and Applications}\\
    
        2026 & \textbf{Session Organizer}, ``Innovations in Spatial Accessibility (2)'' \href{https://i-guide.io/aag-2026-symposium-on-spatial-ai-data-science-frontiers-and-applications/}{AAG 2026 Symposium on Spatial AI and Data Science: Frontiers and Applications}\\
    ...
    \begin{titemize}
        \item Environment and Planning B\: Urban Analytics and City Science, Sage
    ...
    % \vspace*{0.25cm}
    \subheading{University-Level Service}
    \begin{mytable}
        2025- & \textbf{Faculty Reviewer}, The Exley Undergraduate Research Journal \\
    \end{mytable}


    \subheading{Department- and Program-Level Service}
    \begin{mytable}
        2026- & \textbf{Member}, EPPS Rankings Committee \\

        2025- & \textbf{Member}, Geospatial Information Sciences Ph.D. Admissions Committee \\
    \end{mytable}


    \subheading{Chair of the Examining Committee}
    \begin{mytable}
        2026 & Sunmin Hong, UTD \\
    \end{mytable}

    % \vspace*{0.25cm}
\resheading{Students Advised}
\vspace*{0.25cm}


    \subheading{PhD Students Advised}
    \begin{mytable}
        2026 & Khushali Shah, Committee Member, UTD\\
        2025 & Kristine Hahm, Committee Member, UTD \\
    \end{mytable}

    \subheading{Masters Students Advised}
    \begin{mytable}
        2026 & Ann Nibana Stephen Lal, UTD\\
    \end{mytable}
    

    \subheading{Undergraduate Student Mentees}
    \begin{mytable}
        2026 & Sanjula Juttada, B.S. in Data Science, UTD \\
        2026 & Ahyaan Syed, B.S. in Data Science, UTD \\
        2025 & Vaibhavi Srivastava, B.S. in CS+GGIS, UIUC \\
        2025 & Akriti Arora, B.S. in CS, UIUC \\
        2023-25 & Ian Zhang, B.S. in CS+Math, UIUC \\
