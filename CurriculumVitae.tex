...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\resitem{Worked for Praedicat, Inc. automating information extraction and aggregation from unstructured web data for business profiling.}
	...
	\item
		...
		\begin{itemize}
			\resitem{Selected during my first year to tutor students and serve as a teaching assistant in mathematics and computer science.}
	...
	\end{itemize}
		...
		\begin{itemize}
			\resitem{Lead a team of mathematicians over a single weekend in COMAP's International Mathematical Modeling Competition to produce a \href{https://alexandermichels.github.io/docs/ProblemB.pdf}{20-page research paper}.}
