...
\begin{document}
	...
	\resheading{\textcolor{white}{Research}}
		...
		\begin{itemize}
			\resitem{Developed an algorithm in Python and Cython for computational fact-checking on knowledge networks called \textit{StreamMiner} based on \href{https://arxiv.org/pdf/1708.07239.pdf}{network flow, relational similarity,} and \href{https://arxiv.org/pdf/1510.05911.pdf}{discriminative path mining} }
			\resitem{Presented our work at the Institute for Pure and Applied Mathematics and continually optmizing the algorithm's Graph Theory algorithm implementations in the hopes of publishing}
		\end{itemize}
