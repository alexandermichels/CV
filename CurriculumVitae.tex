...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\resitem{Developing a website for marketing and recruiting purposes using Bootstrap and Ruby on Rails.}
	...
	\begin{description}[itemsep=1pt]
		...
		\item[Languages:] Python (and Cython), Java, C++, Bash, R, HTML, CSS, XML, Ruby (and Ruby on Rails), Javascript, SQL, Visual Basic
